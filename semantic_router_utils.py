...
def setup_routes():
    ...
    application_route = Route(
        ...
        utterances=[
            ...
            "How do I update my application for a scholarship?", 
            "Okay, How do I update my application for a scholarship?", 
            ...
            "Okay, What should I do after submitting the application?", 
            "Can I edit my scholarship application?", 
            "Okay, Can I edit my scholarship application?", 
            ...
            "Okay, What happens after I apply for a scholarship?", 
    ...
    status_route = Route(
        ...
        utterances=[
            ...
            "Okay, How can I check my application status?", 
            "What’s the current status of my scholarship application?", 
            "Okay, What’s the current status of my scholarship application?", 
            "Is my scholarship application approved?", 
            "Okay, Is my scholarship application approved?", 
            "How do I know if my application is being processed?", 
            "Okay, How do I know if my application is being processed?", 
            "Can you provide an update on my application?", 
            "Okay, Can you provide an update on my application?", 
            "When will I hear back about my scholarship application?", 
            "Okay, When will I hear back about my scholarship application?", 
            "Is there a way to track my application?", 
            "Okay, Is there a way to track my application?", 
            "How long does it take to process the application?", 
            "Okay, How long does it take to process the application?", 
            "Has my scholarship been accepted?", 
            "Okay, Has my scholarship been accepted?", 
            "Can I check my status online?", 
            "Okay, Can I check my status online?", 
            "What’s the status of my financial aid application?", 
            "Okay, What’s the status of my financial aid application?", 
            "Have my documents been verified?", 
            "Okay, Have my documents been verified?", 
            "How will I know if my application is rejected?", 
            "Okay, How will I know if my application is rejected?", 
            "Can I get a status update via email?", 
            "Okay, Can I get a status update via email?", 
            "Is there a hotline for application status?", 
            "Okay, Is there a hotline for application status?", 
            "What does ‘under review’ mean for my application?", 
            "Okay, What does ‘under review’ mean for my application?", 
            "Can I appeal a rejected application?", 
            "Okay, Can I appeal a rejected application?", 
            "Is there a portal to check my scholarship status?", 
            "Okay, Is there a portal to check my scholarship status?", 
            "What’s the meaning of ‘pending’ in application status?", 
            "Okay, What’s the meaning of ‘pending’ in application status?", 
            "How do I fix an issue with my application status?", 
            "Okay, How do I fix an issue with my application status?", 
            "Will I get a notification when my application is approved?", "Okay, Will I get a notification when my application is approved?", "Can I check the status without my application ID?", "Okay, Can I check the status without my application ID?", "What’s the status of my renewal application?", "Okay, What’s the status of my renewal application?", "How do I find out why my application was rejected?", "Okay, How do I find out why my application was rejected?", "Is my application eligible for re-evaluation?", "Okay, Is my application eligible for re-evaluation?", "Has my scholarship payment been released?", "Okay, Has my scholarship payment been released?", "When will I get a decision on my application?", "Okay, When will I get a decision on my application?", "How can I follow up on my application?", "Okay, How can I follow up on my application?", "Can I check my application status offline?", "Okay, Can I check my application status offline?", "Is there a delay in processing applications?", "Okay, Is there a delay in processing applications?", "What are the reasons for application delays?", "Okay, What are the reasons for application delays?", "How do I resolve a pending application?", "Okay, How do I resolve a pending application?", "Can I see the history of my application status?", "Okay, Can I see the history of my application status?", "Will I be informed if my status changes?", "Okay, Will I be informed if my status changes?", "How do I get proof of my application approval?", "Okay, How do I get proof of my application approval?", "Is there a way to expedite my application process?", "Okay, Is there a way to expedite my application process?", "How often is the status updated online?", "Okay, How often is the status updated online?", "Is there a timeline for application approval?", "Okay, Is there a timeline for application approval?", "Can I call to know my application status?", "Okay, Can I call to know my application status?", "What does ‘processing’ mean in application status?", "Okay, What does ‘processing’ mean in application status?", "How can I check if my scholarship was awarded?", "Okay, How can I check if my scholarship was awarded?", "Has my application been shortlisted?", "Okay, Has my application been shortlisted?", "How do I know if my application is complete?", "Okay, How do I know if my application is complete?", "Is there a confirmation for submitted applications?", "Okay, Is there a confirmation for submitted applications?", "How can I fix errors in my application?", "Okay, How can I fix errors in my application?", "What should I do if my application is stuck?", "Okay, What should I do if my application is stuck?", "How long will the status show as pending?", "Okay, How long will the status show as pending?", "Is my scholarship award letter ready?", "Okay, Is my scholarship award letter ready?", "Has my application moved to the next stage?", "Okay, Has my application moved to the next stage?", "Why is my application status on hold?", "Okay, Why is my application status on hold?", "Can I request an update on my application?", "Okay, Can I request an update on my application?", "Will I receive an email on application updates?", "Okay, Will I receive an email on application updates?", "Why hasn’t my application status changed?", "Okay, Why hasn’t my application status changed?", "What should I do if my status is incorrect?", "Okay, What should I do if my status is incorrect?", "Is my application under final review?", "Okay, Is my application under final review?", "When will I get a response to my application?", "Okay, When will I get a response to my application?", "Can I view the status history for my application?", "Okay, Can I view the status history for my application?", "Is there a confirmation message after approval?", "Okay, Is there a confirmation message after approval?", "What’s the next step after approval?", "Okay, What’s the next step after approval?", "How do I find out if my scholarship is disbursed?", 
            "Okay, How do I find out if my scholarship is disbursed?",
            "What happens if my application is rejected?", 
            "Can I appeal or request reconsideration if my application is rejected?", 
            "Is there a helpline number or email for status inquiries?", 
            "Will I receive an acknowledgment after submitting my application?", 
            "Is there a final status confirmation process?", 
            "Can I make corrections if my status shows errors?", 
            "How will I be informed if my scholarship is approved?", 
            "What should I do if my status doesn’t update for a long time?", 
            ...
            "Have my documents been verified?", 
            "How will I know if my application is rejected?", 
            "Can I get a status update via email?", "Is there a hotline for application status?", "What does ‘under review’ mean for my application?", "Can I appeal a rejected application?", "Is there a portal to check my scholarship status?", "What’s the meaning of ‘pending’ in application status?", "How do I fix an issue with my application status?", "Will I get a notification when my application is approved?", "Can I check the status without my application ID?", "What’s the status of my renewal application?", "How do I find out why my application was rejected?", "Is my application eligible for re-evaluation?", "Has my scholarship payment been released?", "When will I get a decision on my application?", "How can I follow up on my application?", "Can I check my application status offline?", "Is there a delay in processing applications?", "What are the reasons for application delays?", "How do I resolve a pending application?", "Can I see the history of my application status?", "Will I be informed if my status changes?", "How do I get proof of my application approval?", "Is there a way to expedite my application process?", "How often is the status updated online?", "Is there a timeline for application approval?", "Can I call to know my application status?", "What does ‘processing’ mean in application status?", "How can I check if my scholarship was awarded?", "Has my application been shortlisted?", "How do I know if my application is complete?", "Is there a confirmation for submitted applications?", "How can I fix errors in my application?", "What should I do if my application is stuck?", "How long will the status show as pending?", "Is my scholarship award letter ready?", "Has my application moved to the next stage?", "Why is my application status on hold?", "Can I request an update on my application?", "Will I receive an email on application updates?", "Why hasn’t my application status changed?", "What should I do if my status is incorrect?", "Is my application under final review?", "When will I get a response to my application?", "Can I view the status history for my application?", "Is there a confirmation message after approval?", "What’s the next step after approval?", 
